...
const clickEndpoint = `${website}api/newsletter-click`
...
export default async function handler(request, response) {
  ...
  try {
    await transporter.sendMail({
      ...
      text: `Hi ${recipientName}!\n\n50% launch promo: valid for 7 days after you open this newsletter.\n\nOpen the ${newsletter.title} newsletter: ${linkFor(newsletterSlug)}\n\nACDH Creatives`,
      html: emailHtml({ name: recipientName, newsletter: { ...newsletter, slug: newsletterSlug } }),
    })
